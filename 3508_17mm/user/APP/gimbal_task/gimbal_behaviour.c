...
void gimbal_behaviour_mode_set(Gimbal_Control_t *gimbal_mode_set)
{
    ...
    //云台行为状态机设置，6种模式
    gimbal_behavour_set(gimbal_mode_set);///  GIMBAL_ZERO_FORCE = 0, 	//云台无力
																					//  GIMBAL_INIT=1          	//云台初始化
																					//  GIMBAL_CALI=2           //云台校准
...
//        //到达中值 计时
//				//Note:fabs()返回输入的绝对值
//				//通过云台电机编码器返回的相对角度来判断是否到达INIT_YAW_SET角度
