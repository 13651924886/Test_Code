...
void SPI5Init(void)
{
    ...
    SPI_InitStructure.SPI_Mode = SPI_Mode_Master;												//主机模式，SCK线信号的时序由主机产生
    SPI_InitStructure.SPI_DataSize = SPI_DataSize_8b;
    SPI_InitStructure.SPI_CPOL = SPI_CPOL_High;													//SCK在空闲状态时为高电平
    SPI_InitStructure.SPI_CPHA = SPI_CPHA_2Edge;												//在SCK信号偶数边采集数据
    SPI_InitStructure.SPI_NSS = SPI_NSS_Soft;              							//软件NSS线
